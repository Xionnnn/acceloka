...
export default function Main() {
  return (
    <div>
      {/* hero */}
      <div className="flex flex-col items-center justify-center h-dvh gap-6 px-6">
        <motion.h1
        ...
        <div className="flex border rounded-lg divide-x mb-24">
        ...
        <motion.div
          className="text-sm flex flex-col items-center text-gray-400"
          animate={{ y: [0, -8] }}
          transition={{
            type: "spring",
            bounce: 0.5,
      ...
      {/* about */}
      <div className="relative flex flex-col items-center justify-center h-dvh gap-6 px-6">
        <motion.div
